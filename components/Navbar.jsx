    ...
    return (
        <div className='lg:ml-[255px] lg:max-w-[calc(100vw-255px)] w-full'>
            <div className='bg-primary px-1 md:px-8  lg:px-14 py-5 w-full flex justify-between items-center'>
                ...
                <span className={pathname === '/dashboard/host' ? 'text-white' : 'hidden'} >Host</span>
                <span className={pathname === '/dashboard/exchange-requests' ? 'text-white' : 'hidden'} >Exchange Requests</span>
                <span className={pathname === '/dashboard/salary-hub' ? 'text-white' : 'hidden'} >Salary Hub</span>
                </p>
